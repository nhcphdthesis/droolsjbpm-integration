...
public class HardCodedSimulationDataProvider2 implements SimulationDataProvider {
    ...
    public Map<String, Object> getSimulationDataForNode(Node node) {
        ...
        if ("_6A214820-6CF6-4771-AABE-593F343FC2BB".equals(nodeId)) {
            data.put(SimulationConstants.MIN, new Long(30));
            data.put(SimulationConstants.MAX, new Long(40));
            data.put(SimulationConstants.STAFF_AVAILABILITY, new Integer(2));
        ...
        } else if ("_25109EE4-782A-47D5-8DB2-BA291FBCA3FF".equals(nodeId)) {
